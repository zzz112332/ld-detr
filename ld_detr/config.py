...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--n_epoch", type=int, default=250, help="number of epochs to run")
        ...
        parser.add_argument("--queue_length", type=int, default=65536, help="The length of queue in Distill Align, requires an integer multiple of batch size")
        parser.add_argument("--distillation_coefficient", type=float, default=0.4)
        parser.add_argument("--num_v2t_encoder_layers", type=int, default=2)
        parser.add_argument("--num_encoder1_layers", type=int, default=2)
        parser.add_argument("--num_convolutional_blocks", type=int, default=5)
        parser.add_argument("--num_encoder2_layers", type=int, default=2)
        parser.add_argument("--num_decoder_layers", type=int, default=2)
        parser.add_argument("--num_decoder_loops", type=int, default=3)
    ...
    def parse(self, a_feat_dir=None):
        ...
        if isinstance(self, TestOptions):
            ...
            save_fns = ['ld_detr/model.py', 'ld_detr/transformer.py']
